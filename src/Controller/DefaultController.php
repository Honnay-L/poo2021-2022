...
class DefaultController extends AbstractController
{
    ...
    /**
     * @Route("/edit-a/{id}", name="edit_advert")
     */
    public function editAdvert(int $id, Request $request,PhotoUploader $photoUploader, AdvertRepository $advertRepository, EntityManagerInterface $em): Response
    {
        $user = $this->getUser();
